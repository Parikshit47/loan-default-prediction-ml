...
try:
    ...
    from backend.models.decision_tree import DecisionTreePredictor, resolve_model_path
except ImportError:
    from models.base import BaseModelPredictor
    from models.decision_tree import DecisionTreePredictor, resolve_model_path
...
class SklearnPicklePredictor(DecisionTreePredictor):
    ...
    def __init__(
        ...
        self.pkl_path = resolve_model_path(filename)
        self.load_model()
