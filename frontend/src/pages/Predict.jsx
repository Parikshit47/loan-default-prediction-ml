...
function PredictPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.message ||
          `Failed to connect to the prediction backend (${API_BASE_URL}). Please verify the server is running.`
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="predict-container">
      ...
      <div className="preset-bar">
        ...
        <div className="preset-btn-group">
          <button
            type="button"
            className="btn-preset btn-preset-success d-inline-flex align-items-center gap-1"
          ...
          <button
            type="button"
            className="btn-preset d-inline-flex align-items-center gap-1"
          ...
          <button
            type="button"
            className="btn-preset btn-preset-danger d-inline-flex align-items-center gap-1"
      ...
      <form onSubmit={handleSubmit} className="text-start">
        ...
        <div className="submit-card">
          <div className="d-flex align-items-center gap-3">
            <label className="form-label mb-0 fw-bold d-inline-flex align-items-center gap-1">
          ...
          <button
            type="submit"
            className="btn btn-predict d-inline-flex align-items-center gap-2"
            disabled={loading}
          >
            {loading ? (
              <>
        ...
        >
          ...
          <div className="result-header">
            <div>
              ...
              <h3 className="mb-0 mt-1 d-flex align-items-center gap-2 flex-wrap">
                {result.is_default ? (
                  <>
                    <AlertTriangle size={24} className="text-danger" />
                    <span>Default Likely (High Risk)</span>
                  </>
                ) : (
                  <>
                    <CheckCircle2 size={24} className="text-success" />
                    <span>No Default Predicted (Low/Moderate Risk)</span>
                  </>
                )}
              </h3>
            </div>
          ...
          <div className="probability-section">
            <div className="probability-labels">
              <span className="text-success d-inline-flex align-items-center gap-1">
                <ShieldCheck size={16} />
                <span>Safe Repayment: {(result.non_default_probability * 100).toFixed(1)}%</span>
              </span>
              <span className="text-danger d-inline-flex align-items-center gap-1">
                <AlertTriangle size={16} />
                <span>Default Risk: {(result.default_probability * 100).toFixed(1)}%</span>
              </span>
            </div>
          ...
          <div className="result-summary-box text-start">
            <div className="d-flex align-items-center gap-2 mb-1 text-primary fw-bold">
              <BrainCircuit size={18} />
              <span>AI Decision Insight:</span>
            </div>
